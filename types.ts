...
export const ANIMATION_PRESETS: Record<PresetAnimationName, AnimationPreset> = {
  ...
  "Pulse Glow": {
    ...
    animationData: {
      ...
      dropShadowColor: [
        ...
        createKeyframe(1500, "rgba(4,120,87,0.7)"),
      ],
    },
    timelineState: {
      duration: 1500,
  ...
  Boing: {
    ...
    animationData: {
      ...
      dropShadowY: [
        createKeyframe(500, 20),
        createKeyframe(600, 5),
        createKeyframe(700, 15),
        createKeyframe(1000, 10),
      ],
    },
  ...
  Stomp: {
    ...
    animationData: {
      ...
      scaleX: [
        createKeyframe(500, 1),
        createKeyframe(550, 1.1),
        createKeyframe(650, 0.95),
        createKeyframe(800, 1),
      ],
      scaleY: [
        createKeyframe(500, 1),
        createKeyframe(550, 0.9),
        createKeyframe(650, 1.05),
        createKeyframe(800, 1),
      ],
    },
    timelineState: { duration: 1000, isLooping: false, easing: "easeInOut" },
  ...
  "Conveyor Belt": {
    ...
    animationData: {
      ...
      translateZ: [
        createKeyframe(0, -100, "linear"),
        createKeyframe(1500, 50),
        createKeyframe(3000, -100, "linear"),
      ],
    },

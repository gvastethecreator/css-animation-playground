...
export type EasingValue = EasingName | (string & {});
...
export interface Keyframe {
  ...
  easing: EasingValue; // easing function or custom cubic-bezier string
}
...
export const PROPERTY_ICONS: Record<
  string,
  React.ComponentType<{ size?: number; className?: string; strokeWidth?: number; color?: string }>
> = {
  perspective: View,
...
const createKeyframe = (time: number, value: number | string | boolean, easing: EasingValue = 'linear'): Keyframe => ({
...
export const ANIMATION_PRESETS: Record<PresetAnimationName, AnimationPreset> = {
  ...
  Tada: {
    ...
    animationData: {
      scaleX: [createKeyframe(0, 1), createKeyframe(100, 0.9), createKeyframe(300, 1.1), createKeyframe(1000, 1)],
      scaleY: [createKeyframe(0, 1), createKeyframe(100, 0.9), createKeyframe(300, 1.1), createKeyframe(1000, 1)],
      rotateZ: [
        createKeyframe(0, 0),
        createKeyframe(100, -3),
        createKeyframe(300, 3),
        createKeyframe(500, -3),
        createKeyframe(700, 3),
        createKeyframe(900, -3),
        createKeyframe(1000, 0),
      ],
      brightness: [
        createKeyframe(0, 100),
        createKeyframe(300, 120),
        createKeyframe(500, 100),
        createKeyframe(700, 120),
        createKeyframe(900, 100),
      ],
    },
  ...
  Flash: {
    ...
    animationData: {
      brightness: [
        createKeyframe(0, 100, 'easeOutCubic'),
        createKeyframe(250, 200),
        createKeyframe(500, 50),
        createKeyframe(750, 150),
        createKeyframe(1000, 100),
      ],
      opacity: [
        createKeyframe(0, 1),
        createKeyframe(250, 0.5),
        createKeyframe(500, 1),
        createKeyframe(750, 0.7),
  ...
  'Neon Flash': {
    ...
    animationData: {
      ...
      dropShadowColor: [
        createKeyframe(0, 'rgba(0,0,0,0.5)'),
        createKeyframe(50, 'rgba(219,39,119,1)'),
        createKeyframe(100, 'rgba(0,0,0,0.5)'),
      ],
  ...
  Orbit: {
    ...
    animationData: {
      translateX: [
        createKeyframe(0, 200),
        createKeyframe(1000, 0),
        createKeyframe(2000, -200),
        createKeyframe(3000, 0),
        createKeyframe(4000, 200),
      ],
      translateZ: [
        createKeyframe(0, 0),
        createKeyframe(1000, 100),
        createKeyframe(2000, 0),
        createKeyframe(3000, -100),
        createKeyframe(4000, 0),
      ],
  ...
  Shake: {
    ...
    animationData: {
      translateX: [
        createKeyframe(0, 0, 'easeOutQuad'),
        createKeyframe(100, -10),
        createKeyframe(200, 10),
        createKeyframe(300, -10),
        createKeyframe(400, 10),
        createKeyframe(700, 0),
      ],
      rotateZ: [
        createKeyframe(0, 0, 'easeOutQuad'),
        createKeyframe(100, -3),
        createKeyframe(200, 3),
        createKeyframe(300, -3),
        createKeyframe(400, 3),
        createKeyframe(700, 0),
      ],
    },
  ...
  Wobble: {
    ...
    animationData: {
      translateX: [
        createKeyframe(0, 0),
        createKeyframe(150, -50),
        createKeyframe(300, 40),
        createKeyframe(450, -30),
        createKeyframe(600, 20),
        createKeyframe(1000, 0),
      ],
      rotateZ: [
        createKeyframe(0, 0),
        createKeyframe(150, -5),
        createKeyframe(300, 3),
        createKeyframe(450, -3),
        createKeyframe(600, 2),
        createKeyframe(1000, 0),
      ],
    },
  ...
  Jello: {
    ...
    animationData: {
      skewX: [
        createKeyframe(0, 0),
        createKeyframe(111, 0),
        createKeyframe(222, -12.5),
        createKeyframe(333, 6.25),
        createKeyframe(444, -3.125),
        createKeyframe(666, -0.78125),
        createKeyframe(1000, 0),
      ],
      skewY: [
        createKeyframe(0, 0),
  ...
  RubberBand: {
    ...
    animationData: {
      scaleX: [
        createKeyframe(0, 1),
        createKeyframe(300, 1.25, 'easeOutBack'),
        createKeyframe(400, 0.75),
        createKeyframe(500, 1.15),
        createKeyframe(1000, 1),
      ],
      scaleY: [
        createKeyframe(0, 1),
        createKeyframe(300, 0.75, 'easeOutBack'),
        createKeyframe(400, 1.25),
        createKeyframe(500, 0.85),
        createKeyframe(1000, 1),
      ],
    },
    timelineState: { duration: 1000, isLooping: false, easing: 'easeInOut' },
  ...
  HeadShake: {
    ...
    animationData: {
      translateX: [
        createKeyframe(0, 0),
        createKeyframe(65, -6),
        createKeyframe(185, 5),
        createKeyframe(315, -3),
        createKeyframe(500, 0),
      ],
      rotateZ: [
        createKeyframe(0, 0),
        createKeyframe(65, -9),
        createKeyframe(185, 7),
        createKeyframe(315, -5),
        createKeyframe(500, 0),
      ],
    },
    timelineState: { duration: 1000, isLooping: true, easing: 'easeInOut' },
  ...
  Jiggle: {
    ...
    animationData: {
      rotateZ: [
        createKeyframe(0, 0),
        createKeyframe(100, -4),
        createKeyframe(200, 4),
        createKeyframe(300, -2),
        createKeyframe(500, 0),
      ],
      skewX: [
        createKeyframe(0, 0),
        createKeyframe(100, -8),
        createKeyframe(200, 8),
        createKeyframe(300, -4),
        createKeyframe(500, 0),
      ],
    },
  ...
  Boing: {
    ...
    animationData: {
      translateY: [
        createKeyframe(0, -300, 'easeInCubic'),
        createKeyframe(600, 0),
        createKeyframe(800, -20),
        createKeyframe(1000, 0),
      ],
      scaleX: [
        createKeyframe(500, 1),
        createKeyframe(600, 1.2),
        createKeyframe(700, 1),
        createKeyframe(800, 1.05),
        createKeyframe(1000, 1),
      ],
      scaleY: [
        createKeyframe(500, 1),
        createKeyframe(600, 0.8),
        createKeyframe(700, 1),
        createKeyframe(800, 0.95),
        createKeyframe(1000, 1),
      ],
  ...
  Carousel: {
    ...
    animationData: {
      ...
      translateZ: [
        createKeyframe(0, 200),
        createKeyframe(1000, -200),
        createKeyframe(2000, 200),
        createKeyframe(3000, -200),
        createKeyframe(4000, 200),
      ],
      scaleX: [
        createKeyframe(0, 1),
        createKeyframe(1000, 0.8),
        createKeyframe(2000, 1),
        createKeyframe(3000, 0.8),
        createKeyframe(4000, 1),
      ],
    },
  ...
  Glitch: {
    ...
    animationData: {
      translateX: [
        createKeyframe(0, 0, 'steps(1, end)'),
        createKeyframe(200, 0),
        createKeyframe(210, -10),
        createKeyframe(220, 10),
        createKeyframe(230, -10),
        createKeyframe(240, 0),
        createKeyframe(400, 0),
        createKeyframe(410, 5),
        createKeyframe(420, -5),
        createKeyframe(430, 5),
        createKeyframe(440, 0),
      ],
      opacity: [
        createKeyframe(0, 1, 'steps(1, end)'),
        createKeyframe(205, 0.8),
        createKeyframe(215, 1),
        createKeyframe(405, 0.9),
        createKeyframe(415, 1),
      ],
    },
    timelineState: { duration: 800, isLooping: true, easing: 'linear' },
  },
  ...
  Flicker: {
    ...
    animationData: {
      opacity: [
        createKeyframe(0, 1, 'steps(1, end)'),
        createKeyframe(100, 0.9),
        createKeyframe(150, 1),
        createKeyframe(300, 0.85),
        createKeyframe(350, 1),
        createKeyframe(500, 0.95),
        createKeyframe(550, 1),
      ],
    },
  ...
  Hinge: {
    ...
    animationData: {
      ...
      translateY: [createKeyframe(0, 0), createKeyframe(1600, 0, 'easeInCubic'), createKeyframe(2000, 700)],
      opacity: [createKeyframe(0, 1), createKeyframe(1600, 1, 'easeInCubic'), createKeyframe(2000, 0)],
    },
  ...
  Liquify: {
    ...
    animationData: {
      skewX: [
        createKeyframe(0, 0),
        createKeyframe(250, -10),
        createKeyframe(500, 10),
        createKeyframe(750, -5),
        createKeyframe(1000, 0),
      ],
      skewY: [
        createKeyframe(0, 0),
        createKeyframe(250, 5),
        createKeyframe(500, -5),
        createKeyframe(750, 2.5),
        createKeyframe(1000, 0),
      ],
    },
    timelineState: {
  ...
  'Rock On': {
    ...
    animationData: {
      rotateZ: [
        createKeyframe(0, 0),
        createKeyframe(100, -15),
        createKeyframe(200, 10),
        createKeyframe(300, -15),
        createKeyframe(400, 10),
        createKeyframe(500, 0),
      ],
    },
  ...
  Illuminate: {
    ...
    animationData: {
      ...
      dropShadowColor: [
        createKeyframe(0, 'rgba(255,255,240,0)'),
        createKeyframe(1000, 'rgba(255,255,240,0.6)'),
        createKeyframe(2000, 'rgba(255,255,240,0)'),
      ],
  ...
  Jitter: {
    ...
    animationData: {
      translateX: [
        ...
        createKeyframe(50, 2),
        createKeyframe(75, -2),
        createKeyframe(100, 2),
        createKeyframe(125, -2),
        createKeyframe(150, 0),
      ],
      rotateZ: [
        createKeyframe(0, 0),
        createKeyframe(25, 1),
...
export type AnimationEngine = 'css' | 'gsap' | 'animejs' | 'threejs';

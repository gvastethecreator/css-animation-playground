...
const StageImage = React.forwardRef<HTMLDivElement, StageImageProps>(({ transforms, isAdjusting, isPlaying, imageDataUrl, onFileChange, showStageUI, willChangeString, isExploded, onClick }, ref) => {
        ...
        >
            {imageDataUrl ? (
                ...
                >
                    ...
                    <input id="stage-file-upload" type="file" className="hidden" onChange={(e) => e.target.files && onFileChange(e.target.files[0])} accept="image/*,video/webm" />
                </label>
            )}
        </StageLayers>
    );

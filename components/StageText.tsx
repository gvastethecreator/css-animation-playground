...
const StageText = React.forwardRef<HTMLDivElement, StageTextProps>(({ transforms, isAdjusting, isPlaying, style, showStageUI, willChangeString, isExploded, onClick }, ref) => {
  ...
  const textStyle: React.CSSProperties = {
    ...
    backgroundImage: transforms.textColor === 'rgba(255, 255, 255, 1)' 
